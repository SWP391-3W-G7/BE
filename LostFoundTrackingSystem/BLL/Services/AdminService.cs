...
namespace BLL.Services
{
    public class AdminService : IAdminService
    {
        ...
        public AdminService(ICampusRepository campusRepo, IUserRepository userRepo, IStaffRepository staffRepo)
        {
        ...
        public async Task AssignRoleAndCampusAsync(AssignRoleRequest request)
        {
            ...
            if (request.RoleId == 2)
            {
                var existingStaff = await _staffRepo.GetByUserIdAsync(request.UserId);
                ...
                {
                    existingStaff.CampusId = request.CampusId;
                }
            }
        }
    }
