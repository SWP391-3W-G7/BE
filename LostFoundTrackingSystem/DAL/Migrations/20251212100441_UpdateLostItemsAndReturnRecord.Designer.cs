...
namespace DAL.Migrations
{
    ...
    [Migration("20251212100441_UpdateLostItemsAndReturnRecord")]
    partial class UpdateLostItemsAndReturnRecord
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DAL.Models.Staff", b =>
                {
                    ...
                    b.HasKey("StaffId")
                        .HasName("PK__Staff__96D4AAF719481B07");

                    b.HasIndex("CampusId");

                    b.HasIndex(new[] { "UserId" }, "UQ__Staff__1788CCADBD1D05C3")
                        .IsUnique()
            ...
            modelBuilder.Entity("DAL.Models.ReturnRecord", b =>
                {
                    ...
                    b.HasOne("DAL.Models.Staff", "Staff")
                        ...
                        .HasConstraintName("FK__ReturnRec__Staff__1DB06A4F");
            ...
            modelBuilder.Entity("DAL.Models.Staff", b =>
                {
                    b.HasOne("DAL.Models.Campus", "Campus")
                        .WithMany("Staff")
                        .HasForeignKey("CampusId")
                        .HasConstraintName("FK__Staff__CampusID__0C85DE4D");

                    b.HasOne("DAL.Models.User", "User")
                        .WithOne("Staff")
                        .HasForeignKey("DAL.Models.Staff", "UserId")
                        .HasConstraintName("FK__Staff__UserID__0B91BA14");
